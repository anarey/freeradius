...
OUTPUT="--callgrind-out-file=callgrind.out.0.final "
RADIUSD_FILE="radiusd-0"
...
echo "==============================================="
sudo $VALGRIND$OUTPUT$FREERADIUS &
...
JSON_OUT='kafka_json_messages0.log'

echo "==============================================="
echo "Kafkacat. Get the json messages. output: 'json_out_kafka.log' "
echo $KAFKACAT_PATH/kafkacat -C -c 3 -o beggining -b 10.0.30.89 -t radius0
echo "==============================================="
$KAFKACAT_PATH/kafkacat -C -c 3 -o beggining -b 10.0.30.89 -t radius0 > $JSON_OUT &
...
JSON_CHECK_TEMPLATE="template-0.json"
#DEBUG=" -d"
DEBUG=""
echo "==============================================="
...
CALLGRIND_OUT="callgrind-out-0.log"
